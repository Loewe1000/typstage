...
- **The slides are SVG outlines, not text.** Glyphs go into the file as paths,
  ...
  deck above weighs 211 kB, the nine example decks between 0.50 and 2.13 MB,
  and the largest of them holds 142 SVG trees with 3809 glyph references across
  15 slides. In exchange no font has to load and the layout cannot drift.
