...
#let runtime-words(lang) = {
  let listen = (
    de: (no-note: "keine Notiz",
         ...
         help-speaker: "← → blättern · ↑ ↓ Notiz rollen · Pos1 zum Anfang · Ende zum Schluss · b schwarz · e einfrieren · t Klassenuhr · ⇧← ⇧→ eine Minute · d Zieldauer · r Stundenzähler zurück · m Stift/Zeiger · c Farbe · z Strich zurück · x Folie löschen · l hell/dunkel · + − Notizgröße · o Übersicht · s Notiz im Balken · f Vollbild · n Vortrag nach vorn · p Druck",
    ...
    en: (no-note: "no note",
         ...
         help-speaker: "← → page · ↑ ↓ scroll note · Home to start · End to finish · b black · e freeze · t class clock · ⇧← ⇧→ one minute · d target · r reset elapsed · m pen/pointer · c colour · z undo stroke · x clear slide · l light/dark · + − note size · o overview · s note in bar · f full screen · n raise talk · p print",
    ...
    fr: (no-note: "aucune note",
         ...
         help-speaker: "← → naviguer · ↑ ↓ défiler la note · Origine au début · Fin à la fin · b noir · e figer · t minuterie · ⇧← ⇧→ une minute · d durée visée · r remettre l'écoulé à zéro · m stylo/pointeur · c couleur · z annuler le trait · x effacer la diapo · l clair/sombre · + − taille de la note · o aperçu · s note dans la barre · f plein écran · n ramener l'exposé · p imprimer",
