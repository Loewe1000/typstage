...
#let runtime-words(lang) = {
  let listen = (
    de: (no-note: "keine Notiz",
         ...
         help-speaker-short: "← → blättern · b schwarz · e einfrieren · t Uhr · m Stift/Zeiger · x Folie löschen · ? alle Tasten",
         help-speaker: "← → blättern · ↑ ↓ Notiz rollen · Pos1 zum Anfang · Ende zum Schluss · b schwarz · e einfrieren · t Uhr für die Klasse · ⇧← ⇧→ eine Minute · d Zieldauer · r Uhr zurück · m Stift/Zeiger · c Farbe · z Strich zurück · x Folie löschen · + − Notizgröße · o Übersicht · s Notiz im Balken · f Vollbild · n Vortrag nach vorn · p Druck",
         sp: (clock: "Uhrzeit", elapsed: "verstrichen", target: "Ziel (min)",
              ...
              pointer: "Zeiger",
              timer: "Uhr", over: "Überzeit",
              lost: "kein Vortragsfenster")),
    en: (no-note: "no note",
         help: "← → page · o overview · f full screen · s note · n speaker view · p print",
         help-speaker-short: "← → page · b black · e freeze · t clock · m pen/pointer · x clear slide · ? all keys",
         help-speaker: "← → page · ↑ ↓ scroll note · Home to start · End to finish · b black · e freeze · t clock on the wall · ⇧← ⇧→ one minute · d target · r reset clock · m pen/pointer · c colour · z undo stroke · x clear slide · + − note size · o overview · s note in bar · f full screen · n raise talk · p print",
         sp: (clock: "clock", elapsed: "elapsed", target: "target (min)",
              ...
              pointer: "pointer",
              timer: "clock", over: "over",
              lost: "no talk window")),
    fr: (no-note: "aucune note",
         help: "← → naviguer · o aperçu · f plein écran · s note · n vue présentateur · p imprimer",
         help-speaker-short: "← → naviguer · b noir · e figer · t minuterie · m stylo/pointeur · x effacer la diapo · ? toutes les touches",
         help-speaker: "← → naviguer · ↑ ↓ défiler la note · Origine au début · Fin à la fin · b noir · e figer · t minuterie · ⇧← ⇧→ une minute · d durée visée · r remettre à zéro · m stylo/pointeur · c couleur · z annuler le trait · x effacer la diapo · + − taille de la note · o aperçu · s note dans la barre · f plein écran · n ramener l'exposé · p imprimer",
