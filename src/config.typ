...
#let runtime-words(lang) = {
  let listen = (
    de: (no-note: "keine Notiz",
         ...
         help-speaker: "← → blättern · ↑ ↓ Notiz rollen · Pos1 zum Anfang · Ende zum Schluss · b schwarz · e einfrieren · d Zieldauer · r Uhr zurück · m Stift/Zeiger · c Farbe · z Strich zurück · x Folie löschen · + − Notizgröße · o Übersicht · s Notiz im Balken · f Vollbild · n Vortrag nach vorn · p Druck",
    ...
    en: (no-note: "no note",
         ...
         help-speaker: "← → page · ↑ ↓ scroll note · Home to start · End to finish · b black · e freeze · d target · r reset clock · m pen/pointer · c colour · z undo stroke · x clear slide · + − note size · o overview · s note in bar · f full screen · n raise talk · p print",
    ...
    fr: (no-note: "aucune note",
         ...
         help-speaker: "← → naviguer · ↑ ↓ défiler la note · Origine au début · Fin à la fin · b noir · e figer · d durée visée · r remettre à zéro · m stylo/pointeur · c couleur · z annuler le trait · x effacer la diapo · + − taille de la note · o aperçu · s note dans la barre · f plein écran · n ramener l'exposé · p imprimer",
